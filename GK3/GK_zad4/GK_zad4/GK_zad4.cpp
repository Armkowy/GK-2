// lab3_zad4.cpp : Defines the entry point for the console application.
//
...
void GenerateDisplayLists()
{
	...
	// prawe okno 1
	glTexCoord2f(0.0, 0.0);
	glVertex3f(1.001, 0.66, -0.95);
	glTexCoord2f(1.0, 0.0);
	glVertex3f(1.001, 0.66, -0.4);
	glTexCoord2f(1.0, 1.0);
	glVertex3f(1.001, -0.33, -0.4);
	glTexCoord2f(0.0, 0.0);
	glVertex3f(1.001, 0.66, -0.95);
	glTexCoord2f(1.0, 1.0);
	glVertex3f(1.001, -0.33, -0.4);
	glTexCoord2f(0.0, 1.0);
	glVertex3f(1.001, -0.33, -0.95);

	// prawe okno 2
	glTexCoord2f(0.0, 0.0);
	glVertex3f(1.001, 0.66, -0.3);
	glTexCoord2f(1.0, 0.0);
	glVertex3f(1.001, 0.66, 0.3);
	glTexCoord2f(1.0, 1.0);
	glVertex3f(1.001, -0.33, 0.3);
	glTexCoord2f(0.0, 0.0);
	glVertex3f(1.001, 0.66, -0.3);
	glTexCoord2f(1.0, 1.0);
	glVertex3f(1.001, -0.33, 0.3);
