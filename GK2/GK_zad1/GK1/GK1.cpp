// lab2_zad1.cpp : Defines the entry point for the console application.
//
...
// Definiujemy stałš o wartoci liczby PI
...
{
	GLfloat x, y, z, angle; // Zmienne przechowujšce współrzędne i kšty
	...
	for (angle = 0.0f; angle <= (2.0f*GL_PI)*12.0f; angle += 0.1f)
	{
